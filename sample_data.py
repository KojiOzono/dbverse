...
def insert_data(conn):
    ...
    # ─── 世界平均気温（1900-2024） ───
    temp_data = [
        13.7, 13.7, 13.7, 13.8, 13.7, 13.7, 13.8, 13.8, 13.7, 13.7,  # 1900-1909
        13.7, 13.7, 13.7, 13.8, 13.7, 13.8, 13.7, 13.7, 13.8, 13.8,  # 1910-1919
        13.8, 13.8, 13.8, 13.8, 13.8, 13.9, 13.8, 13.8, 13.8, 13.8,  # 1920-1929
        13.9, 13.9, 13.9, 13.9, 13.9, 13.9, 13.9, 14.0, 14.0, 13.9,  # 1930-1939
        14.0, 14.0, 14.0, 14.0, 14.0, 14.0, 14.0, 14.0, 14.0, 14.0,  # 1940-1949
        13.9, 14.0, 14.0, 14.1, 14.0, 14.0, 13.9, 14.0, 14.1, 14.1,  # 1950-1959
        14.0, 14.1, 14.0, 14.1, 14.0, 14.0, 14.0, 14.0, 14.0, 14.1,  # 1960-1969
        14.2, 14.0, 14.1, 14.2, 14.1, 14.1, 14.0, 14.2, 14.2, 14.2,  # 1970-1979
        14.3, 14.3, 14.2, 14.3, 14.2, 14.3, 14.3, 14.4, 14.4, 14.4,  # 1980-1989
        14.5, 14.5, 14.4, 14.4, 14.5, 14.5, 14.5, 14.6, 14.7, 14.6,  # 1990-1999
        14.5, 14.6, 14.7, 14.7, 14.6, 14.7, 14.7, 14.7, 14.6, 14.7,  # 2000-2009
        14.7, 14.6, 14.7, 14.7, 14.7, 14.8, 14.9, 14.8, 14.8, 14.9,  # 2010-2019
        15.0, 14.9, 14.9, 15.0, 15.1,                                  # 2020-2024
    ]
    for i, temp in enumerate(temp_data):
        conn.execute(
            "INSERT INTO global_temp(year, temperature) VALUES(?,?)",
            (1900 + i, temp))